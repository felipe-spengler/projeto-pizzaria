        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="p-4 sm:p-6 lg:p-8 xl:p-12 relative">
                ...
                <form action="cart.php" method="POST" id="addToCartForm" class="relative">
                    ...
                    <!-- Wizard Controls -->
                    <div
                        class="sticky bottom-0 z-50 bg-white/95 backdrop-blur border-t border-gray-100 p-4 -mx-4 sm:-mx-6 lg:-mx-8 sm:px-6 lg:px-8 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] flex flex-col sm:flex-row gap-3 sm:gap-4 transition-all mt-auto">
                        <!-- Navigation Buttons -->
