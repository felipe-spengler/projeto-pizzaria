    ...
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl">
        ...
        <form class="mt-8 space-y-6" action="login.php" method="POST">
            ...
            <div class="grid grid-cols-1 gap-3">
                ...
                <?php else: ?>
                    <div class="w-full inline-flex justify-center py-3 px-4 border-2 border-gray-200 rounded-lg shadow-sm bg-gray-50 text-sm font-medium text-gray-400 cursor-not-allowed">
